...
$ cd BanglaSocialBias
$ conda create python==3.10.12 -p ./venv
$ conda activate ./venv
...
For more details on our methodology and the filtering process, please refer to the [paper](https://arxiv.org/abs/2407.06432).



## Data
<!-- Give the original link of the data -->
We use the annotated dataset from [Islam et al. (2022)](https://aclanthology.org/2022.aacl-short.17/). It contains public comments from social media covering 12 different domains such as Personal, Politics, and Health, labeled for 6 fine-grained emotion categories of the Junto Emotion Wheel (Love, Fear, Anger, Sadness, Surprise, Joy). The original dataset can be found [here](https://www.kaggle.com/datasets/saifsust/emonoba). We refined the data for our use, extracting examples that meet the following criteria:
...
The results are showcased and analyzed in details inside `Section 6: Results and Evaluation` of the [paper](https://arxiv.org/abs/2407.06432).
...
```
@misc{sadhu2024empiricalstudygenderedstereotypes,
      ...
      archivePrefix={arXiv},
      primaryClass={cs.CL},
      url={https://arxiv.org/abs/2407.06432}, 
}
```
