...
def example_data():
    ...
    # ]
    df1 = pd.read_csv(
        "/home/jayanta/Documents/BanglaGenerativeBias/GraphGeneration/ordered_list_I1_latest.csv"
    )
    df2 = pd.read_csv(
        "/home/jayanta/Documents/BanglaGenerativeBias/GraphGeneration/ordered_list_I2_latest.csv"
    )
